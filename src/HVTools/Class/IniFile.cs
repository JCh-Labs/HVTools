...
namespace HVTools.Class
{
    public class IniFile
    {
        ...
        public string GetString(string sectionName, string keyName, string defaultValue)
        {
            ...
            NativeMethods.GetPrivateProfileString(sectionName, keyName, defaultValue, retval, MaxSectionSize, _mPath);
        ...
        /// a null reference  (Nothing in VB)
        /// </exception>
        public short GetInt16(string sectionName, string keyName, short defaultValue)
        {
        ...
        /// a null reference  (Nothing in VB)
        /// </exception>
        public bool GetBoolean(string sectionName, string keyName, bool defaultValue)
        {
            string str = GetString(sectionName, keyName, "");
            if (String.IsNullOrEmpty(str))
            {
        ...
        public List<KeyValuePair<string, string>> GetSectionValuesAsList(string sectionName)
        {
            ...
            try
            {
                ...
                int len = NativeMethods.GetPrivateProfileSection(sectionName, ptr, MaxSectionSize, _mPath);
        ...
        public string[] GetKeyNames(string sectionName)
        {
            ...
            try
            {
                ...
                len = NativeMethods.GetPrivateProfileString(sectionName, null, null, ptr, MaxSectionSize, _mPath);
        ...
        public string[] GetSectionNames()
        {
            ...
            {
                //Get the section names into the buffer.
                len = NativeMethods.GetPrivateProfileSectionNames(ptr, MaxSectionSize, _mPath);
