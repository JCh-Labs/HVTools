...
namespace HVTools.Helpers
{
    internal class OsVersionInfo
    {
        ...
        public static int RevisionVersion => IsWindows10() || IsWindows11() ? 0 : Environment.OSVersion.Version.Revision;
        ...
        // Tjekker om det er Windows 11 baseret på build nummer og produktnavn
        private static bool IsWindows11()
        {
            var productName = RegistryRead(@"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion", "ProductName", "");
            if (productName.StartsWith("Windows 11", StringComparison.OrdinalIgnoreCase)) return true;

            // Windows 11 har build nummer 22000 eller højere
            var buildNumber = BuildVersion;
            if (buildNumber >= 22000) return true;
                ...
                if (GetVersionEx(ref osVersionInfo))
                {
                    ...
                    switch (majorVersion)
                    {
                        ...
                        case 10:
                            ...
                            int ed10;
                            if (GetProductInfo(majorVersion, minorVersion, osVersionInfo.wServicePackMajor,
                                osVersionInfo.wServicePackMinor, out ed10))
                                switch (ed10)
                                {
                                    case ProductCore:
                                        edition = "Home";
                                    ...
                                    case ProductCoreN:
                                        edition = "Home N";
                                        break;
                                    case ProductCoreCountrySpecific:
                                        edition = "Home China";
                                        break;
                                    case ProductCoreSingleLanguage:
                                        edition = "Home Single Language";
                                        break;
                                    case ProductEducation:
                                        edition = "Education";
                                        break;
                                    case ProductEducationN:
                                        edition = "Education N";
                                        break;
                                    case ProductEnterprise:
                                        edition = "Enterprise";
                                    ...
                                    case ProductProfessionalN:
                                        edition = "Pro N";
                                        break;
                                    case ProductProfessionalEducation:
                                        edition = "Pro Education";
                                        break;
                                    case ProductProfessionalEducationN:
                                        edition = "Pro Education N";
                                        break;
                                    case ProductProfessionalWorkstation:
                                        edition = "Pro for Workstations";
                                        break;
                                    case ProductProfessionalWorkstationN:
                                    ...
                                    case ProductWebServer:
                                        ...
                                        break;
                                    case ProductWebServerCore:
                                        edition = "Server Web (core installation)";
                                        break;
                                    case ProductStorageStandardServer:
                                        edition = "Server Storage Standard";
                                        break;
                                    case ProductStorageWorkgroupServer:
                                        edition = "Server Storage Workgroup";
                                        break;
                                    case ProductStorageEnterpriseServer:
                                        edition = "Server Storage Enterprise";
                                        break;
                                    case ProductServerForSmallbusiness:
                                        edition = "Server Essentials";
                                        break;
                                    case ProductHyperv:
        ...
        // Windows 10/11 specific editions
        private const int ProductCore = 0x00000065;
        private const int ProductCoreN = 0x00000062;
        private const int ProductCoreCountrySpecific = 0x00000063;
        private const int ProductCoreSingleLanguage = 0x00000064;
        ...
        private const int ProductProfessionalWorkstationN = 0x000000A2;
